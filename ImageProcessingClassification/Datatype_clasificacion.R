...
r2018_a <- rast("2018a.tif")  
r2018_b <- rast("2018b.tif")
r2018_c <- rast("2018c.tif")
...
map2018 <- mosaic(r2018_a,r2018_b,r2018_c)
...
writeRaster(cm2018, filename = "./2018_Class_utm.tif", datatype = "INT1U")
