...
#terra::writeRaster(ddis_parches, filename = "G:/Mi unidad/Consultorias/wwf_Paisaje_Pacifico_Central/Rasters/Variables/disParches2019.tif",overwrite = TRUE)
...
rc <- terra::classify(dis_parches, rclmat, include.lowest = TRUE)
terra::plot(rc)
